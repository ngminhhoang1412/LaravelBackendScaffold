...
<head><title>[[data:country:""]]</title><!--[if !mso]><!-->
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="width:232px;"><img alt="" height="auto"
                                                                          src="https://07g64.mjt.lu/tplimg/07g64/b/lyi6h/6sxt1.jpeg"
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
            ...
            <tr>
                <td style="direction:ltr;font-size:0px;padding:20px 0px 0px 0px;padding-bottom:0px;padding-left:0px;padding-right:0px;text-align:center;">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="" style="vertical-align:middle;width:600px;"><![endif]-->
                    <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div
                                            ...
                                            <h3 style="text-align:left; margin-top: 10px; margin-bottom: 10px; font-weight: normal;">
                                                <span
                                                    style="line-height:26px;letter-spacing:normal;font-size:20px;font-family:Tahoma;color:#27272b;text-align:left;"><b>Follow us on:</b></span>
                                            </h3></div>
                                    </td>
                                </tr>
                                </tbody>
                                    ...
                                    <td align="right"
                                            ...
                                            <tr>
                                                <td style="padding:4px;vertical-align:middle;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation"
                                                           style="background:#3B5998;border-radius:50%;width:32;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="padding:0px 0px 0px 0px;font-size:0;height:32;vertical-align:middle;width:32;">
                                                                <a href="https://www.facebook.com/moligroup.co" target="_blank"><img
                                                                        height="32"
                                        ...
                                        <table align="right" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="padding:4px;vertical-align:middle;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation"
                                                           style="background:#FF0000;border-radius:50%;width:32;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="padding:0px 0px 0px 0px;font-size:0;height:32;vertical-align:middle;width:32;">
                                                                <a href="https://www.youtube.com/channel/UC6_Lm7O2UArufEp23vx4OZw"
                                        ...
                                        <table align="right" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="padding:4px;vertical-align:middle;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation"
                                                           style="background:#0077B5;border-radius:50%;width:32;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="padding:0px 0px 0px 0px;font-size:0;height:32;vertical-align:middle;width:32;">
                                                                <a href="https://www.linkedin.com/company/moligroup/"
                                                                   target="_blank"><img height="32"
                                        ...
                                        <table align="right" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="padding:4px;vertical-align:middle;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation" style="border-radius:50%;width:32;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="padding:0px 0px 0px 0px;font-size:0;height:32;vertical-align:middle;width:32;">
                                                                <a href="https://moligroup.co/" target="_blank"><img
                                                                        height="32"
                                                                        src="https://07g64.mjt.lu/tplimg/07g64/b/lyi6h/6sxzh.png"
                                                                        style="border-radius:50%;display:block;"
                                                                        width="32"></a></td>
                                                        </tr>
                                                        </tbody>
